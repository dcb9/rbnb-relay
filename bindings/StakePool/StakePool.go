...
// GetPendingRedelegateTime is a free data retrieval call binding the contract method 0x7ff96b01.
//
// Solidity: function getPendingRedelegateTime(address valSrc, address valDst) view returns(uint256)
func (_StakePool *StakePoolCaller) GetPendingRedelegateTime(opts *bind.CallOpts, valSrc common.Address, valDst common.Address) (*big.Int, error) {
	var out []interface{}
	err := _StakePool.contract.Call(opts, &out, "getPendingRedelegateTime", valSrc, valDst)
...
//
// Solidity: function getPendingRedelegateTime(address valSrc, address valDst) view returns(uint256)
func (_StakePool *StakePoolSession) GetPendingRedelegateTime(valSrc common.Address, valDst common.Address) (*big.Int, error) {
	return _StakePool.Contract.GetPendingRedelegateTime(&_StakePool.CallOpts, valSrc, valDst)
}

// GetPendingRedelegateTime is a free data retrieval call binding the contract method 0x7ff96b01.
//
// Solidity: function getPendingRedelegateTime(address valSrc, address valDst) view returns(uint256)
func (_StakePool *StakePoolCallerSession) GetPendingRedelegateTime(valSrc common.Address, valDst common.Address) (*big.Int, error) {
	return _StakePool.Contract.GetPendingRedelegateTime(&_StakePool.CallOpts, valSrc, valDst)
}
